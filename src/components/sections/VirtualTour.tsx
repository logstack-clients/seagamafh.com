...
import type { RoomCategory } from '@/types/sections.types';

const VirtualTour: React.FC = () => {
	if (!tour.rooms[0]) return null;
	...
	const currentCategoryData = tour.rooms.find(c => c.category === activeCategory) || tour.rooms[0];
