	...
	members: [
		{
			...
			role: 'Provider & LPN',
			image: '/images/staff/provider-and-lpn.webp'
		},
		{
			name: 'Mrs. Fatou Senghore',
			role: 'Resident Manager',
			image: '/images/staff/resident-manager.webp'
		},
		{
			name: 'Ms. Awa Dampha',
			role: 'Registered Nurse',
			image: '/images/staff/registered-nurse.webp'
		}
	],
...
export const footer: FooterContentConfig = {
	logo: '/images/others/logo-footer.webp',
